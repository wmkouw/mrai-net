...
if vis:
    # Target prediction
    P = aiu.subject2image(["/home/wmkouw/Data/Brainweb/sims/subject"+str(tgtprdSub).zfill(2)+"_256_GE2D_3.0T_MRB.raw"], w=256,h=256, norm_pix=True)
    R = aiu.subject2image(["/home/wmkouw/Data/Brainweb/phantoms/subject"+str(tgtprdSub).zfill(2)+"_256.raw"], w=256,h=256, seg=True)   
...
if vis:
    aiu.vis_embedding(net, Ih,Lp,Jh,Up, savefn='vis/b1b3_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'embedding_untrained.png')
...
if vis:
    aiu.vis_embedding(net, Ih,Lp,Jh,Up, savefn='vis/b1b3_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'embedding_trained.png')
...
if vis:
    ...
    savefn = 'vis/b1b3_pred_src_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1b3_pred_spt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1b3_pred_net_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1b3_pred_ntt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1b3_pred_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)

    # Visualize data and true segmentation
    aiu.vis_segmentation(P[0], savefn='vis/b1b3_data_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png', cmap='gray')
    aiu.vis_segmentation(R[0], savefn='vis/b1b3_true_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png')
