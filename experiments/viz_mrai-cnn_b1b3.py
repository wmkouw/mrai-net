...
for n in range(lT):
	for i in range(nI):
		...
		with open('results_cnn/err_exp_acqinv_cnn_b1b3_nT'+str(nT[n])+'_r'+str(iI[i]+1)+'.pickle', 'rb') as handle:
...
# Write results
fig2.savefig('vis/err-lc_exp_acqinv_cnn_b1b3_H.png', bbox_inches='tight', pad_inches=0)
