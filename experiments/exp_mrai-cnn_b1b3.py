...
if viz:
    aiu.viz_embedding(net, Ih,Lp,Jh,Up, savefn='viz/b1b3_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'embedding_untrained.png')
...
if viz:
    aiu.viz_embedding(net, Ih,Lp,Jh,Up, savefn='viz/b1b3_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'embedding_trained.png')
...
if viz:
    ...
    aiu.viz_segmentation(Ph, savefn=savefn)
    ...
    aiu.viz_segmentation(P[0], savefn='viz/b1b3_data_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png', cmap='gray')
    aiu.viz_segmentation(R[0], savefn='viz/b1b3_true_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png')
