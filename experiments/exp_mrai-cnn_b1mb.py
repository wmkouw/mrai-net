...
fnU = []
for j in range(nJ):
    fnJ.append('/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(targetSub[j]+1)+'/T1.nii')
    fnU.append('/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(targetSub[j]+1)+'/LabelsForTesting.nii')
...
fnQ = []
for h in range(nH):
    fnH.append('/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(tgtvalSub[h]+1)+'/T1.nii')
    fnQ.append('/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(tgtvalSub[h]+1)+'/LabelsForTesting.nii')
...
if vis:
    # Target prediction
    P = aiu.subject2image(['/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(tgtprdSub)+'/T1.nii'], w=256,h=256, slice_ix=slice_ix, slice_dim=2, flip=True, norm_pix=True) 
    R = aiu.subject2image(['/home/wmkouw/Data/MRBrains/MRBrainS13DataNii/TrainingData/'+str(tgtprdSub)+'/LabelsForTesting.nii'], w=256,h=256, slice_ix=slice_ix, slice_dim=2, flip=True)
...
if vis:
    aiu.vis_embedding(net, Ih,Lp,Jh,Up, savefn='vis/b1mb_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'_embedding_untrained.png')
...
if vis:
    aiu.vis_embedding(net, Ih,Lp,Jh,Up, savefn='vis/b1mb_cnn_'+'_nT'+str(nT)+'_r'+str(it)+'_embedding_trained.png')
...
if sav: 
    # File name
    fn = 'results_cnn/err_exp_acqinv_cnn_b1mb_nT'+str(nT)+'_r'+str(it)+'.pickle'
    print('Writing to: '+fn)
...
if vis:
    ...
    savefn = 'vis/b1mb_pred_src_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1mb_pred_spt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1mb_pred_net_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1mb_pred_ntt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)
    ...
    Ph[R[0,pD:-pD,pD:-pD]==0] = 0
    savefn = 'vis/b1mb_pred_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png'
    print('Writing image to : '+savefn)
    aiu.vis_segmentation(Ph, savefn=savefn)

    # Visualize data and true segmentation
    aiu.vis_segmentation(P[0], savefn='vis/b1mb_data_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png', cmap='gray')
    aiu.vis_segmentation(R[0], savefn='vis/b1mb_true_tgt_sub'+str(tgtprdSub)+'_nT'+str(nT)+'_r'+str(it)+'.png')
